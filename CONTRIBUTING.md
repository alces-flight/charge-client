...
Go to [the GitHub issue tracker](https://github.com/alces-flight/%GITHUB-PROJECT%/issues?state=open)
...
[GitHub issue tracker for %PROJECT%](https://github.com/alces-flight/%GITHUB-PROJECT%/issues/new)
to report the issue.
...
which can be [found
here](https://www.clahub.com/agreements/alces-flight/%GITHUB-PROJECT%). This
